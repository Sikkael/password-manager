...
var _fastifyZodTestOpenapiClient = require("fastify-zod-test-openapi-client");
...
test(`openapi-client`, async () => {
  ...
  try {
    const client = new _fastifyZodTestOpenapiClient.DefaultApi(new _fastifyZodTestOpenapiClient.Configuration({
      basePath,
    ...
    await (0, _typedJestExpect.tExpect)(client.postTodoItem({
      schemaTodoItem: {
        ...
        label: `todo`,
        state: _fastifyZodTestOpenapiClient.SchemaTodoItemState.Todo,
